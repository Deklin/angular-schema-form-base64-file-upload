        ...
        return {
            ...
            link: function (scope, element, attrs, ngModel) {
                ...
                ngModel.$render = function () {
                    ...
                    if (filename) {
                        if (filename.indexOf(/^(http\:\/\/|https\:\/\/|\/)/igm) < 0)
                            filename = '/' + filename
                        scope.file = {
